...
archive_tar="${ARCHIVE%.*}"
gerefi_archive="${gerefi_PREFIX}${archive_tar}${COMPRESSION_SUFFIX}"
...
# Create gerefi archive
echo Creating ${gerefi_archive}
tar -I "${COMPRESSION_PROGRAM}" -cf "${dir}/${gerefi_archive}" "${archive_dir}"
popd >/dev/null
